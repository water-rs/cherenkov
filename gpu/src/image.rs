...
//! thread and uploaded — converted to premultiplied linear Display P3 — on
//! the render thread.
...
/// The shared image state; dropping the last clone releases the texture.
struct ImageInner {
...
/// An image registered with an engine. Cloning is cheap; the texture is
